...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      {isSidebarOpen && (
        <nav
          className="absolute left-0 after:h-[calc(100vh-65px)] block min-h-screen w-60 flex-row flex-nowrap
        ...
        >
          <a
            ...
            href="/"
          >
            <h1 className="text-xl font-bold text-purple-500 sm:text-sl">
              独立开发者出海去工具大全
            </h1>
          </a>
                  ...
                  <div className="py-2">
                    {categories.map((category) => (
                      <div key={category.category} className="space-y-1">
                        <div className="block cursor-pointer rounded-lg hover:bg-gray-100 hover:text-purple-500 text-primary">
                          <div
